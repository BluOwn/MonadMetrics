...
function hslConvert(o) {
  ...
  if (o instanceof Hsl)
    return o;
  o = o.rgb();
  var r2 = o.r / 255, g = o.g / 255, b = o.b / 255, min3 = Math.min(r2, g, b), max4 = Math.max(r2, g, b), h = NaN, s2 = max4 - min3, l = (max4 + min3) / 2;
  if (s2) {
    if (r2 === max4)
      h = (g - b) / s2 + (g < b) * 6;
    else if (g === max4)
...
function getValidInterval(_ref) {
  var _ref2 = _slicedToArray5(_ref, 2), min3 = _ref2[0], max4 = _ref2[1];
  var validMin = min3, validMax = max4;
  if (min3 > max4) {
    validMin = max4;
    validMax = min3;
  }
...
function calculateStep(min3, max4, tickCount, allowDecimals) {
  var correctionFactor = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0;
  if (!Number.isFinite((max4 - min3) / (tickCount - 1))) {
    return {
  ...
  var step = getFormatStep(new import_decimal2.default(max4).sub(min3).div(tickCount - 1), allowDecimals, correctionFactor);
  var middle;
  if (min3 <= 0 && max4 >= 0) {
    middle = new import_decimal2.default(0);
  } else {
    middle = new import_decimal2.default(min3).add(max4).div(2);
    middle = middle.sub(new import_decimal2.default(middle).mod(step));
  }
  var belowCount = Math.ceil(middle.sub(min3).div(step).toNumber());
  var upCount = Math.ceil(new import_decimal2.default(max4).sub(middle).div(step).toNumber());
  var scaleCount = belowCount + upCount + 1;
  if (scaleCount > tickCount) {
    return calculateStep(min3, max4, tickCount, allowDecimals, correctionFactor + 1);
  }
  if (scaleCount < tickCount) {
...
function getNiceTickValuesFn(_ref3) {
  var _ref4 = _slicedToArray5(_ref3, 2), min3 = _ref4[0], max4 = _ref4[1];
  var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var count = Math.max(tickCount, 2);
  var _getValidInterval = getValidInterval([min3, max4]), _getValidInterval2 = _slicedToArray5(_getValidInterval, 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
  if (cormin === -Infinity || cormax === Infinity) {
    ...
    return min3 > max4 ? reverse(_values) : _values;
  }
  if (cormin === cormax) {
  ...
  return min3 > max4 ? reverse(values) : values;
}
function getTickValuesFn(_ref5) {
  var _ref6 = _slicedToArray5(_ref5, 2), min3 = _ref6[0], max4 = _ref6[1];
  var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var count = Math.max(tickCount, 2);
  var _getValidInterval3 = getValidInterval([min3, max4]), _getValidInterval4 = _slicedToArray5(_getValidInterval3, 2), cormin = _getValidInterval4[0], cormax = _getValidInterval4[1];
  if (cormin === -Infinity || cormax === Infinity) {
    return [min3, max4];
  }
  if (cormin === cormax) {
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
  var _ref8 = _slicedToArray5(_ref7, 2), min3 = _ref8[0], max4 = _ref8[1];
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var _getValidInterval5 = getValidInterval([min3, max4]), _getValidInterval6 = _slicedToArray5(_getValidInterval5, 2), cormin = _getValidInterval6[0], cormax = _getValidInterval6[1];
  if (cormin === -Infinity || cormax === Infinity) {
    return [min3, max4];
  }
  if (cormin === cormax) {
...
function combineComparators(comparatorA, comparatorB) {
  return function isEqual6(a2, b, state) {
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass8(Brush2, [{
    ...
    value: function getIndex(_ref2) {
      ...
      var maxIndex = Brush2.getIndexInRange(scaleValues, max4);
      return {
...
var Line = /* @__PURE__ */ function(_PureComponent) {
  function Line2() {
    ...
    _defineProperty36(_this, "getStrokeDasharray", function(length, totalLength, lines) {
      ...
      return [].concat(_toConsumableArray9(Line2.repeat(lines, count)), _toConsumableArray9(remainLines), emptyLines).map(function(line) {
...
var Area = /* @__PURE__ */ function(_PureComponent) {
  function Area2() {
    ...
    _defineProperty37(_this, "state", {
      isAnimationFinished: true
    });
    _defineProperty37(_this, "id", uniqueId("recharts-area-"));
    _defineProperty37(_this, "handleAnimationEnd", function() {
      var onAnimationEnd2 = _this.props.onAnimationEnd;
      _this.setState({
        isAnimationFinished: true
      });
    ...
    _defineProperty37(_this, "handleAnimationStart", function() {
      var onAnimationStart2 = _this.props.onAnimationStart;
      _this.setState({
        isAnimationFinished: false
      });
...
_defineProperty37(Area, "renderDotItem", function(option, props) {
  ...
  if (/* @__PURE__ */ import_react35.default.isValidElement(option)) {
    ...
    dotItem = /* @__PURE__ */ import_react35.default.createElement(Dot, _extends25({}, rest, {
      key,
      className
    }));
  }
...
var XAxis = /* @__PURE__ */ function(_React$Component) {
  ...
  return _createClass17(XAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react36.default.createElement(XAxisImpl, this.props);
    }
  }]);
...
var YAxis = /* @__PURE__ */ function(_React$Component) {
  ...
  return _createClass18(YAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react37.default.createElement(YAxisImpl, this.props);
    }
  }]);
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ (0, import_react38.isValidElement)(elementPropsCursor) ? /* @__PURE__ */ (0, import_react38.cloneElement)(elementPropsCursor, cursorProps) : /* @__PURE__ */ (0, import_react38.createElement)(cursorComp, cursorProps);
}
...
function _slicedToArray12(arr, i) {
  return _arrayWithHoles13(arr) || _iterableToArrayLimit12(arr, i) || _unsupportedIterableToArray20(arr, i) || _nonIterableRest13();
}
...
var getAxisMapByAxes = function getAxisMapByAxes2(props, _ref2) {
  ...
  return axes.reduce(function(result, child) {
    ...
    var childProps = child.type.defaultProps !== void 0 ? _objectSpread37(_objectSpread37({}, child.type.defaultProps), child.props) : child.props;
    ...
    return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42({}, axisId, _objectSpread37(_objectSpread37({}, childProps), {}, {
      axisType,
      domain,
      categoricalDomain,
      duplicateDomain,
...
var getAxisMapByItems = function getAxisMapByItems2(props, _ref3) {
  ...
  return graphicalItems.reduce(function(result, child) {
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42({}, axisId, _objectSpread37(_objectSpread37({
        axisType
      }, Axis.defaultProps), {}, {
        hide: true,
...
var calculateOffset = function calculateOffset2(_ref5, prevLegendBBox) {
  ...
  var offsetH = Object.keys(yAxisMap).reduce(function(result, id) {
    ...
    if (!entry.mirror && !entry.hide) {
      return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42({}, orientation, result[orientation] + entry.width));
    }
    return result;
  }, {
    left: margin.left || 0,
  ...
  var offsetV = Object.keys(xAxisMap).reduce(function(result, id) {
    ...
    var orientation = entry.orientation;
    if (!entry.mirror && !entry.hide) {
      return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42({}, orientation, (0, import_get5.default)(result, "".concat(orientation)) + entry.height));
    }
    return result;
  }, {
    top: margin.top || 0,
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var getFormatItems = function getFormatItems2(props, currentState) {
    ...
    graphicalItems.forEach(function(item, index) {
      ...
      var itemProps = item.type.defaultProps !== void 0 ? _objectSpread37(_objectSpread37({}, item.type.defaultProps), item.props) : item.props;
      ...
      var axisObj = axisComponents.reduce(function(result, entry) {
        ...
        var axis = axisMap[id];
        return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42(_defineProperty42({}, entry.axisType, axis), "".concat(entry.axisType, "Ticks"), getTicksOfAxis(axis)));
      }, axisObjInitialValue);
  ...
  var updateStateOfAxisMapsOffsetAndStackGroups = function updateStateOfAxisMapsOffsetAndStackGroups2(_ref8, prevState) {
    ...
    var axisObj = axisComponents.reduce(function(result, entry) {
      ...
      return _objectSpread37(_objectSpread37({}, result), {}, _defineProperty42({}, name, getAxisMap(props, _objectSpread37(_objectSpread37({}, entry), {}, {
        graphicalItems,
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty42(_this, "eventEmitterSymbol", Symbol("rechartsEventEmitter"));
      _defineProperty42(_this, "accessibilityManager", new AccessibilityManager());
      _defineProperty42(_this, "handleLegendBBoxUpdate", function(box) {
        if (box) {
      ...
      _defineProperty42(_this, "handleReceiveSyncEvent", function(cId, data, emitter) {
      ...
      _defineProperty42(_this, "handleBrushChange", function(_ref9) {
      ...
      _defineProperty42(_this, "handleMouseEnter", function(e) {
      ...
      _defineProperty42(_this, "triggeredAfterMouseMove", function(e) {
        var mouse = _this.getMouseInfo(e);
      ...
      _defineProperty42(_this, "handleItemMouseLeave", function() {
        _this.setState(function() {
          return {
            isTooltipActive: false
          };
      ...
      _defineProperty42(_this, "handleMouseMove", function(e) {
        e.persist();
        _this.throttleTriggeredAfterMouseMove(e);
      });
      _defineProperty42(_this, "handleMouseLeave", function(e) {
      ...
      _defineProperty42(_this, "handleOuterEvent", function(e) {
      ...
      _defineProperty42(_this, "handleClick", function(e) {
        var mouse = _this.getMouseInfo(e);
        if (mouse) {
      ...
      _defineProperty42(_this, "handleMouseDown", function(e) {
      ...
      _defineProperty42(_this, "handleMouseUp", function(e) {
      ...
      _defineProperty42(_this, "handleTouchMove", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.throttleTriggeredAfterMouseMove(e.changedTouches[0]);
        }
      });
      _defineProperty42(_this, "handleTouchStart", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseDown(e.changedTouches[0]);
        }
      });
      _defineProperty42(_this, "handleTouchEnd", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseUp(e.changedTouches[0]);
        }
      });
      _defineProperty42(_this, "handleDoubleClick", function(e) {
      ...
      _defineProperty42(_this, "handleContextMenu", function(e) {
      ...
      _defineProperty42(_this, "applySyncEvent", function(data) {
      ...
      _defineProperty42(_this, "renderCursor", function(element) {
      ...
      _defineProperty42(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        var elementProps = elementDefaultProps !== void 0 ? _objectSpread37(_objectSpread37({}, elementDefaultProps), element.props) : element.props;
        var axisOption = axisMap && axisMap[elementProps["".concat(axisType, "Id")]];
        return /* @__PURE__ */ (0, import_react39.cloneElement)(element, _objectSpread37(_objectSpread37({}, axisOption), {}, {
          className: clsx_default(axisType, axisOption.className),
          key: element.key || "".concat(displayName, "-").concat(index),
          ticks: getTicksOfAxis(axisOption, true)
        }));
      });
      _defineProperty42(_this, "renderPolarGrid", function(element) {
      ...
      _defineProperty42(_this, "renderLegend", function() {
        ...
        return /* @__PURE__ */ (0, import_react39.cloneElement)(item, _objectSpread37(_objectSpread37({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty42(_this, "renderTooltip", function() {
      ...
      _defineProperty42(_this, "renderBrush", function(element) {
      ...
      _defineProperty42(_this, "renderReferenceElement", function(element, displayName, index) {
        if (!element) {
          return null;
        }
      ...
      _defineProperty42(_this, "renderActivePoints", function(_ref10) {
        var item = _ref10.item, activePoint = _ref10.activePoint, basePoint = _ref10.basePoint, childIndex = _ref10.childIndex, isRange = _ref10.isRange;
        var result = [];
        var key = item.props.key;
        var itemItemProps = item.item.type.defaultProps !== void 0 ? _objectSpread37(_objectSpread37({}, item.item.type.defaultProps), item.item.props) : item.item.props;
        ...
        if (basePoint) {
          result.push(CategoricalChartWrapper2.renderActiveDot(activeDot, _objectSpread37(_objectSpread37({}, dotProps), {}, {
            cx: basePoint.x,
            cy: basePoint.y
      ...
      _defineProperty42(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ (0, import_react39.cloneElement)(element, _objectSpread37(_objectSpread37({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ (0, import_react39.cloneElement)(element, _objectSpread37(_objectSpread37(_objectSpread37({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
      ...
      _defineProperty42(_this, "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react39.cloneElement)(element, _objectSpread37(_objectSpread37({
          key: "recharts-customized-".concat(index)
        }, _this.props), _this.state));
      });
      _defineProperty42(_this, "renderMap", {
        CartesianGrid: {
          handler: renderAsIs,
          once: true
        },
    ...
    return _createClass20(CategoricalChartWrapper2, [{
      ...
      value: function getXScales() {
        ...
        return xAxisMap ? Object.entries(xAxisMap).reduce(function(res, _ref13) {
          ...
          return _objectSpread37(_objectSpread37({}, res), {}, _defineProperty42({}, axisId, axisProps.scale));
        }, {}) : null;
      }
    }, {
      key: "getYScales",
  ...
  _defineProperty42(CategoricalChartWrapper, "displayName", chartName);
  _defineProperty42(CategoricalChartWrapper, "defaultProps", _objectSpread37({
    layout: "horizontal",
    stackOffset: "none",
    barCategoryGap: "10%",
    barGap: 4,
  ...
  _defineProperty42(CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
  ...
  _defineProperty42(CategoricalChartWrapper, "renderActiveDot", function(option, props, key) {
    var dot;
  ...
  var CategoricalChart = /* @__PURE__ */ (0, import_react39.forwardRef)(function CategoricalChart2(props, ref) {
    return /* @__PURE__ */ import_react39.default.createElement(CategoricalChartWrapper, _extends28({}, props, {
      ref
    }));
  });
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\ComparisonChart.tsx"' + id);
  };
...
function ComparisonChart({
  ...
  const formatYAxis = (value) => {
    if (metric === "tps" && value >= 1e3) {
      return `${(value / 1e3).toFixed(1)}k`;
    }
    return value;
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white p-6 rounded-lg shadow-md", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-lg font-semibold mb-4", children: title }, void 0, false, {
      fileName: "app/components/ComparisonChart.tsx",
      lineNumber: 36,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-72", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BarChart, { data, margin: {
      top: 10,
      right: 30,
      left: 20,
      bottom: 40
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(XAxis, { type: "number" }, void 0, false, {
        fileName: "app/components/ComparisonChart.tsx",
        lineNumber: 46,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(YAxis, { type: "category", dataKey: "name", width: 100 }, void 0, false, {
        fileName: "app/components/ComparisonChart.tsx",
        lineNumber: 47,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Tooltip, { formatter: (value) => {
        if (metric === "tps") {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Bar, { dataKey: metric, fill: color2, name: metric === "tps" ? "Transactions Per Second" : metric === "blockTime" ? "Block Time (s)" : "Finality Time (s)" }, void 0, false, {
        fileName: "app/components/ComparisonChart.tsx",
        lineNumber: 58,
        columnNumber: 13
      }, this)
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/_shared/chunk-CZOLP6YT.js.map
