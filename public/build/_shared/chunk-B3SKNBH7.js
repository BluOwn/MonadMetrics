...
var InvalidDomainManifest, RejectedByUser;
var init_AddFrame = __esm({
  "node_modules/@farcaster/frame-core/esm/actions/AddFrame.js"() {
    init_errors();
    InvalidDomainManifest = class extends BaseError {
      name = "AddFrame.InvalidDomainManifest";
      constructor() {
        super("Invalid domain manifest");
      }
    };
    RejectedByUser = class extends BaseError {
...
var init_SignIn = __esm({
  "node_modules/@farcaster/frame-core/esm/actions/SignIn.js"() {
    init_errors();
    RejectedByUser2 = class extends BaseError {
...
var SPECIAL_CHARS_PATTERN, REPEATED_PUNCTUATION_PATTERN, EMOJI_PATTERN, createSimpleStringSchema, secureUrlSchema, frameNameSchema, buttonTitleSchema, CAIP_19_REGEX, caip19TokenSchema, hexColorSchema, aspectRatioSchema, encodedJsonFarcasterSignatureSchema, jsonFarcasterSignatureHeaderSchema;
var init_shared = __esm({
  "node_modules/@farcaster/frame-core/esm/schemas/shared.js"() {
    init_lib();
    SPECIAL_CHARS_PATTERN = /[@#$%^&*+=\/\\|~«»]/;
    REPEATED_PUNCTUATION_PATTERN = /(!{2,}|\?{2,}|-{2,})/;
    EMOJI_PATTERN = /[\u{1F300}-\u{1F9FF}]|[\u{2702}-\u{27B0}]|[\u{2600}-\u{26FF}]|[\u{2B00}-\u{2BFF}]/u;
    createSimpleStringSchema = ({ max, noSpaces } = {}) => {
      ...
      return stringValidations.refine((value) => !EMOJI_PATTERN.test(value), {
        ...
        message: "Special characters (@, #, $, %, ^, &, *, +, =, /, \\, |, ~, \xAB, \xBB) are not allowed"
      }).refine((value) => !REPEATED_PUNCTUATION_PATTERN.test(value), {
        message: "Repeated punctuations (!!, ??, --) are not allowed"
      });
    };
    secureUrlSchema = z.string().url().startsWith("https://", { message: "Must be an https url" }).max(1024);
    frameNameSchema = z.string().max(32);
    buttonTitleSchema = z.string().max(32);
    CAIP_19_REGEX = /^[-a-z0-9]{3,8}:[-_a-zA-Z0-9]{1,32}\/(?:[-a-z0-9]{3,8}:[-.%a-zA-Z0-9]{1,128}(?:\/[-.%a-zA-Z0-9]{1,78})?|native)$/;
    caip19TokenSchema = z.string().regex(CAIP_19_REGEX, { message: "Invalid CAIP-19 asset ID" });
    hexColorSchema = z.string().regex(/^#([0-9A-F]{3}|[0-9A-F]{6})$/i, {
      message: "Invalid hex color code. It should be in the format #RRGGBB or #RGB."
    });
    aspectRatioSchema = z.union([z.literal("1:1"), z.literal("3:2")]);
    encodedJsonFarcasterSignatureSchema = z.object({
      header: z.string(),
      payload: z.string(),
      signature: z.string()
    });
    jsonFarcasterSignatureHeaderSchema = z.object({
      fid: z.number(),
...
var actionLaunchFrameSchema, actionViewTokenSchema, actionSchema, buttonSchema, frameEmbedNextSchema, safeParseFrameEmbed;
var init_embeds = __esm({
  "node_modules/@farcaster/frame-core/esm/schemas/embeds.js"() {
    init_lib();
    init_shared();
    actionLaunchFrameSchema = z.object({
    ...
    actionViewTokenSchema = z.object({
    ...
    frameEmbedNextSchema = z.object({
      version: z.literal("next"),
      imageUrl: secureUrlSchema,
      aspectRatio: aspectRatioSchema.optional(),
      button: buttonSchema
    });
    safeParseFrameEmbed = (rawResponse) => frameEmbedNextSchema.safeParse(rawResponse);
  }
});

// node_modules/@farcaster/frame-core/esm/schemas/notifications.js
var notificationDetailsSchema, sendNotificationRequestSchema, sendNotificationResponseSchema;
var init_notifications = __esm({
  "node_modules/@farcaster/frame-core/esm/schemas/notifications.js"() {
    init_lib();
    init_shared();
    notificationDetailsSchema = z.object({
      url: z.string(),
      token: z.string()
    });
    sendNotificationRequestSchema = z.object({
    ...
    sendNotificationResponseSchema = z.object({
      result: z.object({
...
var eventFrameAddedSchema, eventFrameRemovedSchema, eventNotificationsEnabledSchema, notificationsDisabledSchema, serverEventSchema;
var init_events = __esm({
  "node_modules/@farcaster/frame-core/esm/schemas/events.js"() {
    init_lib();
    init_notifications();
    eventFrameAddedSchema = z.object({
      event: z.literal("frame_added"),
      notificationDetails: notificationDetailsSchema.optional()
    });
    eventFrameRemovedSchema = z.object({
      event: z.literal("frame_removed")
    });
    eventNotificationsEnabledSchema = z.object({
      event: z.literal("notifications_enabled"),
      notificationDetails: notificationDetailsSchema.required()
    });
    notificationsDisabledSchema = z.object({
      event: z.literal("notifications_disabled")
    });
    serverEventSchema = z.discriminatedUnion("event", [
...
var primaryCategorySchema, domainFrameConfigSchema, domainManifestSchema;
var init_manifest2 = __esm({
  "node_modules/@farcaster/frame-core/esm/schemas/manifest.js"() {
    init_lib();
    init_shared();
    primaryCategorySchema = z.enum([
      "games",
      "social",
      "finance",
      "utility",
    ...
    domainFrameConfigSchema = z.object({
...
var require_eventemitter3 = __commonJS({
  "node_modules/eventemitter3/index.js"(exports, module) {
    ...
    function addListener(emitter3, event, fn, context, once) {
      ...
      if (!emitter3._events[evt])
        emitter3._events[evt] = listener, emitter3._eventsCount++;
      else if (!emitter3._events[evt].fn)
        emitter3._events[evt].push(listener);
      else
        emitter3._events[evt] = [emitter3._events[evt], listener];
      return emitter3;
    }
    function clearEvent(emitter3, evt) {
      if (--emitter3._eventsCount === 0)
        emitter3._events = new Events();
      else
        delete emitter3._events[evt];
    }
...
var mockEndpoint, webViewEndpoint, endpoint;
...
var frameHost;
var init_frameHost = __esm({
  "node_modules/@farcaster/frame-sdk/dist/frameHost.js"() {
    init_comlink();
    init_endpoint();
    frameHost = wrap(endpoint);
  }
});
...
var BaseError3, InvalidInputError, ResourceNotFoundError, ResourceUnavailableError, TransactionRejectedError, MethodNotSupportedError, LimitExceededError, VersionNotSupportedError, InvalidRequestError, MethodNotFoundError, InvalidParamsError, InternalError, ParseError;
var init_RpcResponse = __esm({
  "node_modules/ox/_esm/core/RpcResponse.js"() {
    ...
    ResourceNotFoundError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    ResourceUnavailableError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    TransactionRejectedError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    MethodNotSupportedError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    LimitExceededError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    VersionNotSupportedError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    InvalidRequestError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    MethodNotFoundError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    InvalidParamsError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    InternalError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
    ...
    ParseError = class extends BaseError3 {
      constructor(parameters = {}) {
        super({
...
function from(provider2, options = {}) {
  ...
  return {
    ...includeEvents ? {
      on: provider2.on?.bind(provider2),
      removeListener: provider2.removeListener?.bind(provider2)
    } : {},
    async request(args) {
...
var ProviderRpcError, UserRejectedRequestError, UnauthorizedError, UnsupportedMethodError, DisconnectedError, ChainDisconnectedError, IsUndefinedError;
var init_Provider = __esm({
  "node_modules/ox/_esm/core/Provider.js"() {
    ...
    UnauthorizedError = class extends ProviderRpcError {
    ...
    UnsupportedMethodError = class extends ProviderRpcError {
    ...
    DisconnectedError = class extends ProviderRpcError {
    ...
    IsUndefinedError = class extends BaseError2 {
      constructor() {
...
__export(dist_exports, {
  AddFrame: () => AddFrame_exports,
  ComposeCast: () => ComposeCast_exports,
  Context: () => context_exports,
  DEFAULT_READY_OPTIONS: () => DEFAULT_READY_OPTIONS,
  Errors: () => errors_exports,
  Ethereum: () => ethereum_exports,
  Manifest: () => manifest_exports,
  Ready: () => Ready_exports,
  SendToken: () => SendToken_exports,
  SignIn: () => SignIn_exports,
  SwapToken: () => SwapToken_exports,
  ViewProfile: () => ViewProfile_exports,
  ViewToken: () => ViewToken_exports,
  ...
  createSimpleStringSchema: () => createSimpleStringSchema,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1746543936882.175";
}
function useFarcaster() {
  (0, import_react.useEffect)(() => {
    if (typeof window === "undefined")
      return;
    try {
      const sdk2 = (init_dist(), __toCommonJS(dist_exports));
      sdk2.actions.ready();
      sdk2.on("primaryButtonClicked", () => {
        console.log("Primary button clicked");
      });
      return () => {
        sdk2.removeAllListeners();
      };
    } catch (error) {
...
comlink/dist/esm/comlink.mjs:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-B3SKNBH7.js.map
